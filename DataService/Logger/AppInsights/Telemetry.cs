...
namespace Logger.AppInsights
{
    public static class Telemetry
    {
        private static string TelemetryKey = ConfigurationManager.AppSettings["InstrumentationKey"].ToString();
        ...
        private static TelemetryClient GetAppInsightsClient()
        {
            ...
            client.Context.User.Id = "DataService";
